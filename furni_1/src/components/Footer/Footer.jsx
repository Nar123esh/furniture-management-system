...
const Footer = () => {
    ...
    <Container>
        ...
        <Col lg='4'>
                        ...
                        Furniture plays a crucial role in 
                        defining the functionality and 
                        aesthetics of interior spaces, 
                        and the choices made in selecting 
                        and arranging furniture contribute 
                        to the overall design of a room or environment.
